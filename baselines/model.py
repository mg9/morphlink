...
class MLP_VAE_plain(nn.Module):
    ...
    def forward(self, h, breakp=False):
        # encoder
...
class GraphVAE(nn.Module):
    ...
    def forward(self, input_features, adj, g, logger, unmasked_adj=None, breakp=False):
        ...
        h_decode, z_mu, z_lsgms = self.vae(graph_h, breakp)
