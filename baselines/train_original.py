...
from baselines.data import GraphAdjSampler
...
def train(args, dataloader, model):
    ...
    for epoch in range(50):
        ...
        for batch_idx, data in enumerate(dataloader):
            ...
            loss, acc = model(features, adj_input)
            print('graph: %d, acc: %.4f' % (batch_idx, acc))
            loss.backward()
...
def main():
    ...
    print('Number of graphs removed due to upper-limit of number of nodes: ', num_graphs_raw - graphs_len)
